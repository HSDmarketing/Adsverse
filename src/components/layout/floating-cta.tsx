  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 p-2 bg-card border border-border rounded-full shadow-lg">
        ...
        <Button asChild size="icon" variant="ghost" className="rounded-full hover:bg-transparent">
            <Link href="#">
