    ...
    <section id="home" className="relative w-full min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 text-center">
        <div className="max-w-4xl mx-auto">
          <h1 className="font-headline text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight text-transparent bg-clip-text bg-gradient-to-br from-white to-gray-400"
            style={{ textShadow: '0 4px 15px rgba(0,0,0,0.2)' }}
          >
            Where Brands Rise First
          </h1>
          <p className="mt-6 text-lg md:text-xl text-foreground/80 max-w-2xl mx-auto">
            A creative marketing agency that transforms your brand into a shining star. We blend strategy, creativity, and technology to launch you into a new orbit of success.
          </p>
